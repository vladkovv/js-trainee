...
console.log('task1(arr)', any([0, 1, 2, 0], x => x > 0));

console.log('=============');

console.log('task2(arr)', arrayDiff([1, 2, 3], [1, 2, 4]));
...
console.log('task4(arr)', union([5, 1, 3, 3, 4], [1, 3, 4]));

console.log('=============');

console.log('task5(arr)');
const generator = createGenerator([1, '2', 10, 8, 6]);
